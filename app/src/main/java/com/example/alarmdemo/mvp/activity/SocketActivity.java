...
public class SocketActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.create_conn:
                if (isConnected) {
                    Toast.makeText(SocketActivity.this, "Socket已连接", Toast.LENGTH_SHORT).show();
                    return;
                }
                // 初始化socket
                initEasySocket();
    ...
    private void sendProgressMsg() {
        ...
        IProgressDialog progressDialog = new IProgressDialog() {
            ...
            public Dialog getDialog() {
                ProgressDialog dialog = new ProgressDialog(SocketActivity.this);
        ...
        EasySocket.getInstance().upCallbackMessage(sender)
                .onCallBack(new SimpleCallBack(sender.getCallbackId()) {
                    ...
                    public void onResponse(OriginReadData data) {
                        ...
                        Toast.makeText(SocketActivity.this, "应答消息：" + data.getBodyString(), Toast.LENGTH_LONG).show();
                    }
    ...
    private void initEasySocket9998() {
        ...
        // 创建一个socket连接
        EasySocket.getInstance().createSpecifyConnection(options, this);
    }
}
